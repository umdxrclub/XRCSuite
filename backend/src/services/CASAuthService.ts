...
import { getValueOfInputFieldWithName, X_WWW_FORM_HEADERS_CONFIG } from "../util/scrape-util";
import { useAxios } from "../util/shared-axios";
...
/**
 * Authenticates the shared Axios client with UMD CAS with the login/password
 * in the host.json file.
 */
export const CASAuth: BackendService = {
